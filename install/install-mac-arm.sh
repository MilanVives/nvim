...
# Download Neovim nightly for ARM64
log_info "Downloading Neovim nightly for ARM64..."
if ! curl -LO https://github.com/neovim/neovim/releases/download/nightly/nvim-macos-arm64.tar.gz; then
